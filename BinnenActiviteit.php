...
if (isset($_GET['id'])) {
    ...
    $isEditing = $edit !== null && $edit->isBinnen();
}

$pageTitle = $isEditing ? 'Bewerk binnen activiteit' : 'Boek binnen activiteit';
$headerTitle = 'Binnen activiteit';
$footerText = 'FoTo-project - Binnen activiteit';
...
<main class="flex-1 w-full">
    <div class="max-w-4xl mx-auto px-4 py-12">
        <section class="rounded-lg p-6 shadow-md" style="background-color:#FAEBD7;">
            <h2 class="text-2xl font-bold mb-4"><?= $isEditing ? 'Bewerk deze binnen activiteit' : 'Boek een binnen activiteit'; ?></h2>
            ...
            <?php else: ?>
                <form action="classes/save_booking.php" method="post" data-form-type="booking">
                    ...
                    <div class="flex gap-3 mt-4">
                        ...
                        <a href="BuitenActiviteit.php" class="ml-auto text-sm underline">Naar buiten activiteit</a>
                    </div>
                </form>
            <?php endif; ?>
        </section>
