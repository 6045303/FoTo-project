...
<head>
	...
	<title>Boek binnen activiteit</title>
...
<body class="min-h-screen flex flex-col" style="background-color:#D3B69C; color:#111111;">
	<header class="w-full" style="background-color:#0B0B45; color:#FFFFFF;">
		<div class="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
			<h1 class="text-xl font-semibold">Activiteiten — Boek binnen</h1>
			<nav>
	...
	<main class="flex-1 w-full">
		<div class="max-w-4xl mx-auto px-4 py-12">
			<section class="rounded-lg p-6 shadow-md" style="background-color:#Faebd7;">
				<h2 class="text-2xl font-bold mb-4">Boek een binnen activiteit</h2>
				<p class="mb-6">Vul het formulier in om een binnen activiteit te boeken. Velden met * zijn verplicht.</p>
				...
				<form action="save_booking.php" method="post" class="space-y-4" novalidate>
					...
					<div>
						...
						<input name="naam" required class="w-full p-3 rounded border" type="text" placeholder="Bijv. Kees de Vries">
					</div>

					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div>
							<label class="block text-sm font-medium mb-1">E-mail *</label>
							<input name="email" required class="w-full p-3 rounded border" type="email" placeholder="6045303@mborijnland.nl">
						</div>
						<div>
							<label class="block text-sm font-medium mb-1">Telefoon</label>
							<input name="telefoon" class="w-full p-3 rounded border" type="tel" placeholder="06-12345678">
						</div>
					</div>
					...
					<div>
						...
						<textarea name="opmerkingen" class="w-full p-3 rounded border" rows="4" placeholder="Bijv. dieetwensen of bijzonderheden"></textarea>
					</div>
					...
					<div class="flex gap-3 mt-2">
						...
						<a href="buiten_activiteit.php" class="ml-auto text-sm underline">Naar buiten activiteit</a>
					</div>
				</form>
			</section>
		</div>
	...
	<footer class="w-full" style="background-color:#0B0B45; color:#FFFFFF;">
		<div class="max-w-4xl mx-auto px-4 py-4 text-sm text-center">
			&copy; <?php echo date('Y'); ?> FoTo-project — Boek binnen
		</div>
	</footer>
</body>
</html>
